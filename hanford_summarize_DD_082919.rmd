---
title: "Hanford Reach Fall Chinook cumulative DD"
author: "MNSnyder"
date: "8/29/2019"
...
```{r plot DD hist together, fig.cap="Fig. 1. Histograms of modeled Hanford Reach fall Chinook accumulated degrees day over 18°C from Bonneville to the Hanford Reach confluence in the Columbia River."}
plot_grid(c2, a2, b2, d2, g2, e2, f2,
          labels = c("A", "B", "C", "D", "E", "F", "G"),
          ncol = 3, nrow = 3)
```

```{r cum DD boxplot, fig.cap="Fig. 2. Boxplots of modeled Hanford Reach fall Chinook accumulated degrees day over 18°C from Bonneville to the Hanford Reach confluence in the Columbia River."}
...
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 1. Cumulative degree days (>18°C) used across different HexSim thermalscapes summarized for Hanford Reach fall Chinook.", digits=1)
```
...
```{r plot DD hist together 20, fig.cap="Fig. 3. Histograms of modeled Hanford Reach fall Chinook accumulated degrees day over 20°C from Bonneville to the Hanford Reach confluence in the Columbia River."}
plot_grid(c2, a2, b2, d2, g2, e2, f2,
          labels = c("A", "B", "C", "D", "E", "F", "G"),
          ncol = 3, nrow = 3)
```

```{r cum DD boxplot 20, fig.cap="Fig. 4. Boxplots of modeled Hanford Reach fall Chinook accumulated degrees day over 20°C from Bonneville to the Hanford Reach confluence in the Columbia River."}
all_14_ddGT18$scenario<-as.factor(all_14_ddGT18$scenario)

out3<-ggplot(all_14_ddGT18, aes(x=scenario, y=temp_1, group=scenario)) +   
  geom_boxplot() + 
  labs( y="Cumulative degree days (>20°C)", title="Hanford Reach fall Chinook") + 
  theme_classic() 
...
DD_used_table$scenario[DD_used_table$scenario == "G"] <- "Columbia Current, No CWRs"
# create table with pretty format
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 2. Cumulative degree days (>20°C) used across different HexSim thermalscapes summarized for Hanford Reach fall Chinook.", digits=1)
```
...
```{r plot DD hist together 21, fig.cap="Fig. 5. Histograms of modeled Hanford Reach fall Chinook accumulated degrees day over 21°C from Bonneville to the Hanford Reach confluence in the Columbia River."}
plot_grid(c2, a2, d2, g2, e2,
          labels = c("A", "B", "C", "D", "E"),
          ncol = 3, nrow = 2)
```

```{r cum DD boxplot 21, fig.cap="Fig. 6. Boxplots of modeled Hanford Reach fall Chinook accumulated degrees day over 21°C from Bonneville to the Hanford Reach confluence in the Columbia River."}
all_14_ddGT18$scenario<-as.factor(all_14_ddGT18$scenario)

out3<-ggplot(all_14_ddGT18, aes(x=scenario, y=temp_1, group=scenario)) +   
  geom_boxplot() + 
  labs( y="Cumulative degree days (>21°C)", title="Hanford Reach fall Chinook") + 
  theme_classic() 
...
DD_used_table$scenario[DD_used_table$scenario == "G"] <- "Columbia Current, No CWRs"
# create table with pretty format
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 3. Cumulative degree days (>21°C) used across different HexSim thermalscapes summarized for Hanford Reach fall Chinook.", digits=1)
```
