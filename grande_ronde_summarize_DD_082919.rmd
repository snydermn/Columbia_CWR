...
```{r plot DD hist together 23, fig.cap="Fig. 5. Histograms of modeled Grande Ronde River summer steelhead accumulated degrees day over 23°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, d2, g2, e2,
          labels = c("A", "B", "C", "D", "E"),
          ncol = 3, nrow = 2)
```

```{r cum DD boxplot 23, fig.cap="Fig. 6. Boxplots of modeled Grande Ronde River summer steelhead accumulated degrees day over 23°C from Bonneville to the Snake River confluence in the Columbia River."}
all_14_ddGT18$scenario<-as.factor(all_14_ddGT18$scenario)
