...
```{r plot DD hist together, fig.cap="Fig. 3. Histograms of modeled Snake River Fall Chinook accumulated degrees day over 18°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, b2, d2, g2, e2, f2,
          labels = c("A", "B", "C", "D", "E", "F", "G"),
          ncol = 3, nrow = 3)
```

```{r cum DD boxplot, fig.cap="Fig. 4. Boxplots of modeled Snake River Fall Chinook accumulated degrees day over 18°C from Bonneville to the Snake River confluence in the Columbia River."}
...
# create table with pretty format
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 2. Cumulative degree days (>18°C) used across different HexSim thermalscapes summarized for Snake River Fall Chinook.", digits=1)
```
