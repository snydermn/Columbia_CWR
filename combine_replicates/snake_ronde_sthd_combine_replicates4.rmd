...
## snake_Columbia2017B_plus10
```{r snake_Columbia2017B_plus30 set up path to each replicate model run}
path1<-"D:/Results_4Populations/snake_Columbia2017B_plus10/snake_Columbia2017B_plus10-[1]/Data Probe/"
path2<-"D:/Results_4Populations/snake_Columbia2017B_plus10/snake_Columbia2017B_plus10-[2]/Data Probe/"
path3<-"D:/Results_4Populations/snake_Columbia2017B_plus10/snake_Columbia2017B_plus10-[3]/Data Probe/"
...
```{r snake_Columbia2017B_plus10 create unique ID for each CSV for replicates}
...
```{r snake_Columbia2017B_plus10 combine like replicate DFs from lists into individual DFs}
#### combine tibbles from different lists into DF ####
# creates DF A1 through A17
# create combined folder before running
dir.create("D:/Results_4Populations/snake_Columbia2017B_plus10/combined/")
setwd("D:/Results_4Populations/snake_Columbia2017B_plus10/combined/")
...
## snake_Columbia2017B_plus30
```{r snake_Columbia2017B_plus30 set up path to each replicate model run}
path4<-"D:/Results_4Populations/snake_Columbia2017B_plus30/snake_Columbia2017B_plus30-[1]/Data Probe/"
path5<-"D:/Results_4Populations/snake_Columbia2017B_plus30/snake_Columbia2017B_plus30-[2]/Data Probe/"
path6<-"D:/Results_4Populations/snake_Columbia2017B_plus30/snake_Columbia2017B_plus30-[3]/Data Probe/"

```

For each replicate imports all CSVs in Data Probe folder into a list of tibbles. Each path defined above needs to be specified below to read in CSVs and create new unique ID.
```{r snake_Columbia2017B_plus30 create unique ID for each CSV for replicates}
## creates a list of tibbles of all CSVs in directory
...
Need to specify lists to be combined below (files1, files2, files3). Drops intermediate columns used to create unique ID and re-orders columns to match original order of columns.
```{r snake_Columbia2017B_plus30 combine like replicate DFs from lists into individual DFs}
#### combine tibbles from different lists into DF ####
dir.create("D:/Results_4Populations/snake_Columbia2017B_plus30/combined/")
setwd("D:/Results_4Populations/snake_Columbia2017B_plus30/combined/")
...
## snake_Columbia2017B_plus50
```{r Columbia 2017 plus 1 set up path to each replicate model run}
path7<-"D:/Results_4Populations/snake_Columbia2017B_plus50/snake_Columbia2017B_plus50-[1]/Data Probe/"
path8<-"D:/Results_4Populations/snake_Columbia2017B_plus50/snake_Columbia2017B_plus50-[2]/Data Probe/"
path9<-"D:/Results_4Populations/snake_Columbia2017B_plus50/snake_Columbia2017B_plus50-[3]/Data Probe/"

```

For each replicate imports all CSVs in Data Probe folder into a list of tibbles. Each path defined above needs to be specified below to read in CSVs and create new unique ID.
```{r snake_Columbia2017B_plus50 create unique ID for each CSV for replicates}
## creates a list of tibbles of all CSVs in directory
...
Need to specify lists to be combined below (files1, files2, files3). Drops intermediate columns used to create unique ID and re-orders columns to match original order of columns.
```{r snake_Columbia2017B_plus50 combine like replicate DFs from lists into individual DFs}
#### combine tibbles from different lists into DF ####
dir.create("D:/Results_4Populations/snake_Columbia2017B_plus50/combined/")
setwd("D:/Results_4Populations/snake_Columbia2017B_plus50/combined/")
