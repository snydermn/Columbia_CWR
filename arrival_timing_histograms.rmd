...
```{r GR density}
p <- ggplot(data = all_13_labels, aes(x = terminus_date, group=scenario)) + geom_density( aes(linetype = scenario, color=scenario), size=1) + theme_classic()+
  labs(x="Exit Day", y="Count", fill="", title="Grande Ronde River Summer Steelhead") +
...
```{r import end condition}
# import in combined replicate DFs
A13sr<-read.table("D:/Results_4Populations/snake_Columbia2017B/combined/E4.csv", header=TRUE, sep=",")
B13sr<-read.table("D:/Results_4Populations/snake_Columbia2017B_NoCWR/combined/F4.csv", header=TRUE, sep=",")
C13sr<-read.table("D:/Results_4Populations/snake_Columbia2017BplusOne/combined/G4.csv", header=TRUE, sep=",")
D13sr<-read.table("D:/Results_4Populations/snake_Columbia2017BplusOne_NoCWR/combined/H4.csv", header=TRUE, sep=",")
...
width1 = 6
height1 = 4
png("C:/Users/msnyde02/OneDrive - Environmental Protection Agency (EPA)/Profile/Desktop/Manuscript CWR Columbia/draft figures/arrival timing/SR_hist_arrival.png", res=res1, width=width1, height=height1, units="in", type="windows", antialias = "none")
par(mar=c(6, 4, 4, 2) + 0.5)
 z
dev.off() 

png("C:/Users/msnyde02/OneDrive - Environmental Protection Agency (EPA)/Profile/Desktop/Manuscript CWR Columbia/draft figures/arrival timing/GR_hist_arrival.png", res=res1, width=width1, height=height1, units="in", type="windows", antialias = "none")
