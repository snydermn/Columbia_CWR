...
```{r A13 hist}
a1<-ggplot(A13, aes(x=ED_per_used)) + geom_histogram(aes(x=ED_per_used, y=100 * (..count..)/sum(..count..))) + xlim(0,15) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
