---
title: "sensitivity testing acute mortality"
author: "MNSnyder"
date: "1/8/2020"
...
C13$scenario<-"Increase acute mortality with CWRs A"
D13$scenario<-"Increase acute mortality without CWRs A"
E13$scenario<-"Increase acute mortality with CWRs B"
F13$scenario<-"Increase acute mortality without CWRs B"
...
# p <- ggplot(data = all_GR2, aes(x = terminus_date, fill=scenario)) + geom_density( alpha=0.5) + theme_classic()
...
p <- ggplot(data = all_GR2, aes(x = terminus_date, colour=scenario)) + geom_density( alpha=0.5) + theme_classic()
