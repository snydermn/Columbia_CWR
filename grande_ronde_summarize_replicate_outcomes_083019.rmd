...
# histograms
z <- ggplot(data = all_13_labels_current, aes(x = date)) + geom_histogram(bins=90) + labs(x="Modeled Passage Date (Snake River confluence)", y="Count") + scale_x_datetime(limits = ymd_hms(c("2019-06-01 17:00:00", "2020-04-20 17:00:00")))
z 
```
