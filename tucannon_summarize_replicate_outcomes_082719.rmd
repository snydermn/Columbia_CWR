...
# A13$energy_density_used<-A13$Initial_energy_density-A13$Fitness_energy
# A13$ED_per_used<-(A13$energy_density_used / A13$Initial_energy_density) * 100
# A13$scenario<-"A"
# 
# B13$energy_density_used<-B13$Initial_energy_density-B13$Fitness_energy
# B13$ED_per_used<-(B13$energy_density_used / B13$Initial_energy_density) * 100
# B13$scenario<-"B"
# 
# C13$energy_density_used<-C13$Initial_energy_density-C13$Fitness_energy
# C13$ED_per_used<-(C13$energy_density_used / C13$Initial_energy_density) * 100
# C13$scenario<-"C"
# 
# D13$energy_density_used<-D13$Initial_energy_density-D13$Fitness_energy
# D13$ED_per_used<-(D13$energy_density_used / D13$Initial_energy_density) * 100
# D13$scenario<-"D"
# 
# E13$energy_density_used<-E13$Initial_energy_density-E13$Fitness_energy
# E13$ED_per_used<-(E13$energy_density_used / E13$Initial_energy_density) * 100
# E13$scenario<-"E"
# 
# F13$energy_density_used<-F13$Initial_energy_density-F13$Fitness_energy
# F13$ED_per_used<-(F13$energy_density_used / F13$Initial_energy_density) * 100
# F13$scenario<-"F"
# 
# G13$energy_density_used<-G13$Initial_energy_density-G13$Fitness_energy
...
kable(refuge_use_all, col.names=c("Scenario", "Total CWR Residence (h)"), caption="Table 3. Model output for total hours residing n cold water refuges summarized for Tucannon River Summer Steelhead.")
```
