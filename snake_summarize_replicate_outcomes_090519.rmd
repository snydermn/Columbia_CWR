...
# import in combined replicate DFs
A14<-fread("D:/Results_4Populations/snake_Columbia2040_current/combined/A14.csv", header=TRUE, sep=",")
B14<-fread("D:/Results_4Populations/snake_Columbiarestored_CWRcurrent/combined/B14.csv", header=TRUE, sep=",")
C14<-fread("D:/Results_4Populations/snake_current_current/combined/C14.csv", header=TRUE, sep=",")
D14<-fread("D:/Results_4Populations/snake_current_restoredCWR/combined/D14.csv", header=TRUE, sep=",")
E14<-fread("D:/Results_4Populations/snake_Columbia2040_No_CWR/combined/E14.csv", header=TRUE, sep=",")
F14<-fread("D:/Results_4Populations/snake_Columbiarestored_No_CWR/combined/F14.csv", header=TRUE, sep=",")
G14<-fread("D:/Results_4Populations/snake_current_current_No_CWR/combined/G14.csv", header=TRUE, sep=",")
...
```{r plot DD hist together, eval=FALSE, fig.cap="Fig. 3. Histograms of modeled Snake River River fall Chinook accumulated degrees day over 18°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, b2, d2, g2, e2, f2,
          labels = c("A", "B", "C", "D", "E", "F", "G"),
          ncol = 3, nrow = 3)
```

```{r cum DD boxplot, eval=FALSE, fig.cap="Fig. 4. Boxplots of modeled Snake River River fall Chinook accumulated degrees day over 18°C from Bonneville to the Snake River confluence in the Columbia River."}
...
p + facet_wrap(~scenario) + labs(x="Exit Day", y="Count", title="Snake River fall Chinook")
