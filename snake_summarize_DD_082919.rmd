...
```{r A14 hist}
a2<-ggplot(A14_ddGT18, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,500) + ylim(0,30) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
...
```{r B14 hist}
b2<-ggplot(B14_ddGT18, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,500) + ylim(0,30) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
...
```{r C14 hist}
c2<-ggplot(C14_ddGT18, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,500) + ylim(0,30) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
...
```{r D14 hist}
d2<-ggplot(D14_ddGT18, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,500) + ylim(0,30) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>18°C)", y="Percent", title="Columbia Current, \nCWR Restored")
```

```{r E14 hist}
e2<-ggplot(E14_ddGT18, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,500) + ylim(0,30) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>18°C)", y="Percent", title="Columbia 2040, \nNo CWRs")
```

```{r F14 hist}
f2<-ggplot(F14_ddGT18, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,500) + ylim(0,30) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>18°C)", y="Percent", title="Columbia Restored, \nNo CWRs")
```

```{r G14 hist}
g2<-ggplot(G14_ddGT18, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,500) + ylim(0,30) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>18°C)", y="Percent", title="Columbia Current, \nNo CWRs")
```

```{r plot DD hist together, fig.cap="Fig. 1. Histograms of modeled Snake River fall Chinook accumulated degrees day over 18°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, b2, d2, g2, e2, f2,
          labels = c("A", "B", "C", "D", "E", "F", "G"),
          ncol = 3, nrow = 3)
```

```{r cum DD boxplot, fig.cap="Fig. 2. Boxplots of modeled Snake River fall Chinook accumulated degrees day over 18°C from Bonneville to the Snake River confluence in the Columbia River."}
all_14_ddGT18$scenario<-as.factor(all_14_ddGT18$scenario)

out3<-ggplot(all_14_ddGT18, aes(x=scenario, y=temp_1, group=scenario)) +   
  geom_boxplot() + 
  labs( y="Cumulative degree days (>18°C)", title="Snake River fall Chinook") + 
  theme_classic() 
...
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 1. Cumulative degree days (>18°C) used across different HexSim thermalscapes summarized for Snake River fall Chinook.", digits=1)
```
...
```{r plot DD hist together 20, fig.cap="Fig. 3. Histograms of modeled Snake River fall Chinook accumulated degrees day over 20°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, b2, d2, g2, e2, f2,
          labels = c("A", "B", "C", "D", "E", "F", "G"),
          ncol = 3, nrow = 3)
```

```{r cum DD boxplot 20, fig.cap="Fig. 4. Boxplots of modeled Snake River fall Chinook accumulated degrees day over 20°C from Bonneville to the Snake River confluence in the Columbia River."}
all_14_ddGT18$scenario<-as.factor(all_14_ddGT18$scenario)

out3<-ggplot(all_14_ddGT18, aes(x=scenario, y=temp_1, group=scenario)) +   
  geom_boxplot() + 
  labs( y="Cumulative degree days (>20°C)", title="Snake River fall Chinook") + 
  theme_classic() 
...
DD_used_table$scenario[DD_used_table$scenario == "G"] <- "Columbia Current, No CWRs"
# create table with pretty format
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 2. Cumulative degree days (>20°C) used across different HexSim thermalscapes summarized for Snake River fall Chinook.", digits=1)
```
...
```{r plot DD hist together 21, fig.cap="Fig. 5. Histograms of modeled Snake River fall Chinook accumulated degrees day over 21°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, d2, g2, e2,
          labels = c("A", "B", "C", "D", "E"),
          ncol = 3, nrow = 2)
```

```{r cum DD boxplot 21, fig.cap="Fig. 6. Boxplots of modeled Snake River fall Chinook accumulated degrees day over 21°C from Bonneville to the Snake River confluence in the Columbia River."}
all_14_ddGT18$scenario<-as.factor(all_14_ddGT18$scenario)

out3<-ggplot(all_14_ddGT18, aes(x=scenario, y=temp_1, group=scenario)) +   
  geom_boxplot() + 
  labs( y="Cumulative degree days (>21°C)", title="Snake River fall Chinook") + 
  theme_classic() 
...
DD_used_table$scenario[DD_used_table$scenario == "G"] <- "Columbia Current, No CWRs"
# create table with pretty format
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 3. Cumulative degree days (>21°C) used across different HexSim thermalscapes summarized for Snake River fall Chinook.", digits=1)
```
...
b2<-ggplot(B14_ddGT18, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,500) + ylim(0,30) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>22°C)", y="Percent", title="Columbia Restored, \nCWR Current")
```
...
```{r plot DD hist together 22, fig.cap="Fig. 5. Histograms of modeled Snake River fall Chinook accumulated degrees day over 22°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, d2, g2, e2,
          labels = c("A", "B", "C", "D", "E"),
          ncol = 3, nrow = 2)
```

```{r cum DD boxplot 22, fig.cap="Fig. 6. Boxplots of modeled Snake River fall Chinook accumulated degrees day over 22°C from Bonneville to the Snake River confluence in the Columbia River."}
all_14_ddGT18$scenario<-as.factor(all_14_ddGT18$scenario)

out3<-ggplot(all_14_ddGT18, aes(x=scenario, y=temp_1, group=scenario)) +   
  geom_boxplot() + 
  labs( y="Cumulative degree days (>22°C)", title="Snake River fall Chinook") + 
  theme_classic() 
...
DD_used_table$scenario[DD_used_table$scenario == "G"] <- "Columbia Current, No CWRs"
# create table with pretty format
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 3. Cumulative degree days (>22°C) used across different HexSim thermalscapes summarized for Snake River fall Chinook.", digits=1)
```
...
b2<-ggplot(B14_ddGT18, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,500) + ylim(0,30) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>23°C)", y="Percent", title="Columbia Restored, \nCWR Current")
```
...
```{r plot DD hist together 23, fig.cap="Fig. 5. Histograms of modeled Snake River fall Chinook accumulated degrees day over 23°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, d2, g2, e2,
          labels = c("A", "B", "C", "D", "E"),
          ncol = 3, nrow = 2)
```

```{r cum DD boxplot 23, fig.cap="Fig. 6. Boxplots of modeled Snake River fall Chinook accumulated degrees day over 23°C from Bonneville to the Snake River confluence in the Columbia River."}
all_14_ddGT18$scenario<-as.factor(all_14_ddGT18$scenario)

out3<-ggplot(all_14_ddGT18, aes(x=scenario, y=temp_1, group=scenario)) +   
  geom_boxplot() + 
  labs( y="Cumulative degree days (>23°C)", title="Snake River fall Chinook") + 
  theme_classic() 
...
DD_used_table$scenario[DD_used_table$scenario == "G"] <- "Columbia Current, No CWRs"
# create table with pretty format
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 3. Cumulative degree days (>23°C) used across different HexSim thermalscapes summarized for Snake River fall Chinook.", digits=1)
```
