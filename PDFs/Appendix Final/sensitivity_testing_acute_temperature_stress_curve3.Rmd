---
title: "<span style='font-size: 20px'><b>13. Sensitivity testing of acute temperature stress curve </b></style>"
author: " "
date: " "
...
To evaluate uncertainty around how acute temperature stress influences fish fitness outcomes we performed a sensitivity analysis of the acute temperature stress curve. Sensitivity tests were based on a typical recent temperature year (2017) for the Columbia River. The effect of changing the shape of the temperature stress survival curve was measured on percent mortality. Two different curves were evaluated: an exponential relationship with LC10 and LC50 values from Jager et al. 2011 (exponential) and a curve defined in Sullivan et al. 2000 (logistic). The default acute temperature stress equation was based on the curve from the InStream model (Railsback et al. 2009). We compared three thermalscapes to the current thermalscape with CWRs: current year 2017 Columbia River temperatures without CWRs, warmer Columbia River (year 2017 +1°C), and warmer Columbia River (year 2017 +1°C without CWRs). We modeled the Grande Ronde Summer Steelhead population because of their large range in propensity to behaviorally thermoregulate.
...
```{r plot temperature stress curves, fig.cap="Fig. 13.1 Acute temperature stress curves tested in sensitivity experiment."}
width1=4
height1=2.5
...
A_end$thermalscape<-"Current (2017)"
B_end$thermalscape<-"Current (2017)"
C_end$thermalscape<-"Future (2017)"
D_end$thermalscape<-"Future (2017) no CWR"
E_end$thermalscape<-"Current (2017)"
F_end$thermalscape<-"Future (2017)"
G_end$thermalscape<-"Future (2017) no CWR"
H_end$thermalscape<-"Future (2017) no CWR"
I_end$thermalscape<-"Future (2017)"
J_end$thermalscape<-"Current (2017) no CWR"
K_end$thermalscape<-"Current (2017) no CWR"
L_end$thermalscape<-"Current (2017) no CWR"
...
names_v<-c("Current (2017), Default", "Current (2017), Logistic","Future (2017), Logistic","Future (2017) no CWR, Logistic","Current (2017), Exponential","Future (2017), Exponential","Future (2017) no CWR, Exponential", "Future (2017) no CWR, Default", "Future (2017), Default", "Current (2017) no CWR, Exponential", "Current (2017) no CWR, Logistic", "Current (2017) no CWR, Default")
...
acute_all$names_v <- factor(acute_all$names_v, levels=c("Current (2017), Default", "Current (2017) no CWR, Default", "Future (2017), Default", "Future (2017) no CWR, Default", "Current (2017), Logistic", "Current (2017) no CWR, Logistic", "Future (2017), Logistic", "Future (2017) no CWR, Logistic", "Current (2017), Exponential", "Current (2017) no CWR, Exponential", "Future (2017), Exponential", "Future (2017) no CWR, Exponential"))

kable(acute_all, digits=1, col.names=c("Scenario", "Total mortality"), caption="Table 13.1 Model output for percent of individuals dying from acute temperature stress summarized for Grande Ronde River Summer Steelhead.")
```


```{r GR calculate mean plus error energy used, eval=FALSE}
...
```{r percent energy used plot, eval=FALSE, fig.cap="Fig. 1. Fish fitness model outcomes for the population showing mean (±SE) percent of energy used.  "}
...
```{r percent energy used boxplot, eval=FALSE, fig.cap="Fig. 2. Boxplot of modeled percent energy loss for Grande Ronde River summer steelhead with risk adverse behavioral thermoregulation. The factor modifies the move to cold water refuge probability based on model week in relation to maximum Columbia River temperature."}
...
```{r energy lost table, eval=FALSE}
