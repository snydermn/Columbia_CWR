---
title: '<span style=''font-size: 20px''><b>8. Energy use, CWR use, and survivorship results for Hanford Reach Fall Chinook Salmon under long-term average temperatures for the Columbia River </b></style>'
author: " "
date: " "
...
```{r plot energy hist together, fig.cap="Fig. 8.1 Histogram of percent energy lost for modeled Hanford Reach Fall Chinook salmon migrating through six different modeled thermalscapes."}
...
```{r energy lost boxplot, fig.cap="Fig. 8.2 Boxplot of percent energy lost for modeled Hanford Reach Fall Chinook migrating through six different modeled thermalscapes."}
...
kable(ED_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 8.1 Percent energy used across different HexSim thermalscapes summarized for Hanford Reach Fall Chinook.", digits=1)
```
...
kable(refuge_use_all, digits=0, col.names=c("Scenario", "CWR Residence (h/individual)"), caption="Table 8.2 Model output for hours residing in cold water refuges summarized for Hanford Reach Fall Chinook.")
```
...
kable(acute_all,digits=2,  col.names=c("Scenario", "Total mortality"), caption="Table 8.3 Model output for percent of individuals dying from acute temperature stress summarized for Hanford Reach Fall Chinook.")
```
