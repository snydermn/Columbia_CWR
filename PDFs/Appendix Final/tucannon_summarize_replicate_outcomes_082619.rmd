---
title: '<span style=''font-size: 20px''><b>2. Energy use, CWR use, and survivorship results for Tucannon River summer steelhead under long-term average temperatures for the Columbia River </b></style>'
author: " "
date: " "
output:
...
```{r plot energy hist together, fig.cap="Fig. 2.1 Histogram of percent energy lost for modeled Grande Ronde summer steelhead migrating through different modeled thermalscapes."}
...
```{r energy lost boxplot, fig.cap="Fig. 2.2 Boxplot of percent energy lost for modeled Grande Ronde summer steelhead migrating through different modeled thermalscapes."}
...
kable(ED_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 2.1 Percent energy used across different HexSim thermalscapes summarized for Tucannon River Summer Steelhead.", digits=1)
```
...
kable(refuge_use_all, digits = 0, col.names=c("Scenario", "CWR Residence (h/individual)"), caption="Table 2.2 Model output for hours residing in cold water refuges summarized for Tucannon River Summer Steelhead.")
```
...
kable(acute_all, digits=2, col.names=c("Scenario", "Total mortality"), caption="Table 2.3 Model output for percent of individuals dying from acute temperature stress summarized for Tucannon River Summer Steelhead.")
