---
title: '<span style=''font-size: 20px''><b>10. Energy use, CWR use, and survivorship results for Grande Ronde River summer steelhead under year 2017 temperatures for the Columbia River </b></style>'
author: " "
date: " "
...
```{r plot energy hist together, fig.cap="Fig. 10.1 Histogram of percent energy lost for modeled Grande Ronde summer steelhead migrating through different modeled thermalscapes."}
...
```{r energy lost boxplot, fig.cap="Fig. 10.2 Boxplot of percent energy lost for modeled Grande Ronde summer steelhead migrating through different modeled thermalscapes."}
...
kable(ED_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 10.1 Percent energy used across different HexSim thermalscapes summarized for Grande Ronde River Summer Steelhead.", digits=1)
```
...
kable(refuge_use_all, digits=0, col.names=c("Scenario", "CWR Residence (h/individual)"), caption="Table 10.2 Model output for hours residing in cold water refuges summarized for Grande Ronde River Summer Steelhead.")
```
...
kable(acute_all, digits=2, col.names=c("Scenario", "Total mortality"), caption="Table 10.3 Model output for percent of individuals dying from acute temperature stress summarized for Grande Ronde River Summer Steelhead.")
