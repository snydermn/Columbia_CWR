---
title: '<span style=''font-size: 20px''><b>3. Cumulative degree days summary results for Grande Ronde River summer steelhead under long-term average temperatures for the Columbia River </b></style>'
author: " "
date: " "
...
```{r plot DD hist together, fig.cap="Fig. 3.1 Histograms of modeled Grande Ronde River summer steelhead accumulated degrees day over 18°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, b2, g2, e2, f2,
          labels = c("A", "B", "C", "D", "E", "F"),
          ncol = 3, nrow = 2)
```

```{r cum DD boxplot, fig.cap="Fig. 3.2 Boxplots of modeled Grande Ronde River summer steelhead accumulated degrees day over 18°C from Bonneville to the Snake River confluence in the Columbia River."}
...
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 3.1 Cumulative degree days (>18°C) used across different HexSim thermalscapes summarized for Grande Ronde River Summer Steelhead.", digits=1)
```
...
```{r plot DD hist together 20, fig.cap="Fig. 3.3 Histograms of modeled Grande Ronde River summer steelhead accumulated degrees day over 20°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, b2, g2, e2, f2,
          labels = c("A", "B", "C", "D", "E", "F"),
          ncol = 3, nrow = 2)
```

```{r cum DD boxplot 20, fig.cap="Fig. 3.4 Boxplots of modeled Grande Ronde River summer steelhead accumulated degrees day over 20°C from Bonneville to the Snake River confluence in the Columbia River."}
all_14_ddGT18$scenario<-as.factor(all_14_ddGT18$scenario)
...
DD_used_table$scenario[DD_used_table$scenario == "G"] <- "Columbia Current, No CWRs"
# create table with pretty format
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 3.2 Cumulative degree days (>20°C) used across different HexSim thermalscapes summarized for Grande Ronde River Summer Steelhead.", digits=1)
```
...
thres<-21
# run for each scenario's hourly DF
A14_ddGT21<-dum_dd(thres, A14)
#B14_ddGT21<-dum_dd(thres, B14)
C14_ddGT21<-dum_dd(thres, C14)
#D14_ddGT21<-dum_dd(thres, D14)
E14_ddGT21<-dum_dd(thres, E14)
#F14_ddGT21<-dum_dd(thres, F14)
G14_ddGT21<-dum_dd(thres, G14)
# add scenario column
A14_ddGT21$scenario<-"A"
#B14_ddGT21$scenario<-"B"
C14_ddGT21$scenario<-"C"
#D14_ddGT21$scenario<-"D"
E14_ddGT21$scenario<-"E"
#F14_ddGT21$scenario<-"F"
G14_ddGT21$scenario<-"G"

#combine
all_14_ddGT21<-rbind.data.frame(A14_ddGT21,  C14_ddGT21, E14_ddGT21, G14_ddGT21)

```


```{r A14 hist 21}
a2<-ggplot(A14_ddGT21, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
...
b2<-ggplot(B14_ddGT21, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
...
```{r C14 hist 21}
c2<-ggplot(C14_ddGT21, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
...
```{r D14 hist 21}
#d2<-ggplot(D14_ddGT21, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
#        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>20°C)", y="Percent", title="Columbia Current, \nCWR Restored")
```

```{r E14 hist 21}
e2<-ggplot(E14_ddGT21, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>21°C)", y="Percent", title="Columbia 2040, \nNo CWRs")
```

```{r F14 hist 21, eval=FALSE}
f2<-ggplot(F14_ddGT21, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>21°C)", y="Percent", title="Columbia Historic, \nNo CWRs")
```

```{r G14 hist 21}
g2<-ggplot(G14_ddGT21, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>21°C)", y="Percent", title="Columbia Current, \nNo CWRs")
```

```{r plot DD hist together 21, fig.cap="Fig. 3.5 Histograms of modeled Grande Ronde River summer steelhead accumulated degrees day over 21°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, g2, e2,
          labels = c("A", "B", "C", "D"),
          ncol = 3, nrow = 2)
```

```{r cum DD boxplot 21, fig.cap="Fig. 3.6 Boxplots of modeled Grande Ronde River summer steelhead accumulated degrees day over 21°C from Bonneville to the Snake River confluence in the Columbia River."}
all_14_ddGT21$scenario<-as.factor(all_14_ddGT21$scenario)

out3<-ggplot(all_14_ddGT21, aes(x=scenario, y=temp_1, group=scenario)) +   
  geom_boxplot() + 
...
```{r DD lost table 21}
DD_used_table<-aggregate(temp_1~scenario, data=all_14_ddGT21, quantile)
DD_used_table$scenario<-as.character(DD_used_table$scenario)
DD_used_table<-format(DD_used_table, digits = 0) # round 
...
DD_used_table$scenario[DD_used_table$scenario == "G"] <- "Columbia Current, No CWRs"
# create table with pretty format
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 3.3 Cumulative degree days (>21°C) used across different HexSim thermalscapes summarized for Grande Ronde River Summer Steelhead.", digits=1)
```
...
thres<-22
# run for each scenario's hourly DF
A14_ddGT22<-dum_dd(thres, A14)
#B14_ddGT22<-dum_dd(thres, B14)
C14_ddGT22<-dum_dd(thres, C14)
#D14_ddGT22<-dum_dd(thres, D14)
E14_ddGT22<-dum_dd(thres, E14)
#F14_ddGT22<-dum_dd(thres, F14)
G14_ddGT22<-dum_dd(thres, G14)
# add scenario column
A14_ddGT22$scenario<-"A"
#B14_ddGT22$scenario<-"B"
C14_ddGT22$scenario<-"C"
#D14_ddGT22$scenario<-"D"
E14_ddGT22$scenario<-"E"
#F14_ddGT22$scenario<-"F"
G14_ddGT22$scenario<-"G"

#combine
all_14_ddGT22<-rbind.data.frame(A14_ddGT22,  C14_ddGT22, E14_ddGT22, G14_ddGT22)

```


```{r A14 hist 22}
a2<-ggplot(A14_ddGT22, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
...
b2<-ggplot(B14_ddGT22, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
...
```{r C14 hist 22}
c2<-ggplot(C14_ddGT22, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
...
```{r E14 hist 22}
e2<-ggplot(E14_ddGT22, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>22°C)", y="Percent", title="Columbia 2040, \nNo CWRs")
```

```{r F14 hist 22, eval=FALSE}
f2<-ggplot(F14_ddGT22, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>22°C)", y="Percent", title="Columbia Historic, \nNo CWRs")
```

```{r G14 hist 22}
g2<-ggplot(G14_ddGT22, aes(x=temp_1)) + geom_histogram(aes(x=temp_1, y=100 * (..count..)/sum(..count..))) + xlim(0,1000) + ylim(0,25) + theme_classic() + theme(legend.position="none", axis.text=element_text(size=text1),
        title=element_text(size=8),axis.title=element_text(size=text1)) + labs(x="Cumulative degree days (>22°C)", y="Percent", title="Columbia Current, \nNo CWRs")
```

```{r plot DD hist together 22, fig.cap="Fig. 3.5 Histograms of modeled Grande Ronde River summer steelhead accumulated degrees day over 22°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, g2, e2,
          labels = c("A", "B", "C", "D"),
          ncol = 3, nrow = 2)
```

```{r cum DD boxplot 22, fig.cap="Fig. 3.6 Boxplots of modeled Grande Ronde River summer steelhead accumulated degrees day over 22°C from Bonneville to the Snake River confluence in the Columbia River."}
all_14_ddGT22$scenario<-as.factor(all_14_ddGT22$scenario)

out3<-ggplot(all_14_ddGT22, aes(x=scenario, y=temp_1, group=scenario)) +   
  geom_boxplot() + 
...
```{r DD lost table 22}
DD_used_table<-aggregate(temp_1~scenario, data=all_14_ddGT22, quantile)
DD_used_table$scenario<-as.character(DD_used_table$scenario)
DD_used_table<-format(DD_used_table, digits = 0) # round 
...
DD_used_table$scenario[DD_used_table$scenario == "G"] <- "Columbia Current, No CWRs"
# create table with pretty format
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 3.3 Cumulative degree days (>22°C) used across different HexSim thermalscapes summarized for Grande Ronde River Summer Steelhead.", digits=1)
```
