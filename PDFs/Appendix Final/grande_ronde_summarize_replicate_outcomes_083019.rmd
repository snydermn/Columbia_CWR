---
title:  '<span style=''font-size: 20px''><b>Section 4. Energy use, CWR use, and survivorship results for Grande Ronde River summer steelhead under long-term average temperatures for the Columbia River </b></style>'
author: " "
date: " "
...
kable(acute_all, col.names=c("Scenario", "Total mortality"), caption="Table 4.3 Model output for percent of individuals dying from acute temperature stress summarized for Grande Ronde River Summer Steelhead.")

```



```{r time in system histogram, eval=FALSE}
...
```{r terminus arrival histogram, eval=FALSE}
...
```{r terminus arrival histogram for current w and without CWR, eval=FALSE}
...
```{r terminus arrival histogram for current w and without CWR 2, eval=FALSE}
# subset data to the two scenarios
all_13_labels_2<-filter(all_13_labels, scenario == "Columbia Current, CWR Current" | scenario == "Columbia Current, No CWRs")
all_13_labels_2$scenario<-factor(all_13_labels_2$scenario)
