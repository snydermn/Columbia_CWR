---
title: "<span style='font-size: 20px'><b>7. Cumulative degree days summary results for Hanford Reach Fall Chinook Salmon under long-term average temperatures for the Columbia River </b></style>"
author: " "
date: " "
...
```{r plot DD hist together, fig.cap="Fig. 7.1 Histograms of modeled Hanford Reach fall Chinook accumulated degrees day over 18°C from Bonneville to the Hanford Reach confluence in the Columbia River."}
plot_grid(c2, a2, b2, g2, e2, f2,
          labels = c("A", "B", "C", "D", "E", "F"),
          ncol = 3, nrow = 2)
```

```{r cum DD boxplot, fig.cap="Fig. 7.2 Boxplots of modeled Hanford Reach fall Chinook accumulated degrees day over 18°C from Bonneville to the Hanford Reach confluence in the Columbia River."}
...
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 7.1 Cumulative degree days (>18°C) used across different HexSim thermalscapes summarized for Hanford Reach fall Chinook.", digits=1)
```
...
```{r plot DD hist together 20, fig.cap="Fig. 7.3 Histograms of modeled Hanford Reach fall Chinook accumulated degrees day over 20°C from Bonneville to the Hanford Reach confluence in the Columbia River."}
plot_grid(c2, a2, b2, g2, e2, f2,
          labels = c("A", "B", "C", "D", "E", "F"),
          ncol = 3, nrow = 2)
```

```{r cum DD boxplot 20, fig.cap="Fig. 7.4 Boxplots of modeled Hanford Reach fall Chinook accumulated degrees day over 20°C from Bonneville to the Hanford Reach confluence in the Columbia River."}
all_14_ddGT18$scenario<-as.factor(all_14_ddGT18$scenario)
...
DD_used_table$scenario[DD_used_table$scenario == "G"] <- "Columbia Current, No CWRs"
# create table with pretty format
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 7.2 Cumulative degree days (>20°C) used across different HexSim thermalscapes summarized for Hanford Reach fall Chinook.", digits=1)
```
...
```{r plot DD hist together 21, fig.cap="Fig. 7.5 Histograms of modeled Hanford Reach fall Chinook accumulated degrees day over 21°C from Bonneville to the Hanford Reach confluence in the Columbia River."}
plot_grid(c2, a2, g2, e2,
          labels = c("A", "B", "C", "D"),
          ncol = 3, nrow = 2)
```

```{r cum DD boxplot 21, fig.cap="Fig. 7.6 Boxplots of modeled Hanford Reach fall Chinook accumulated degrees day over 21°C from Bonneville to the Hanford Reach confluence in the Columbia River."}
all_14_ddGT18$scenario<-as.factor(all_14_ddGT18$scenario)
...
DD_used_table$scenario[DD_used_table$scenario == "G"] <- "Columbia Current, No CWRs"
# create table with pretty format
kable(DD_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 7.3 Cumulative degree days (>21°C) used across different HexSim thermalscapes summarized for Hanford Reach fall Chinook.", digits=1)
```
