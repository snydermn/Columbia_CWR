---
title: '<span style=''font-size: 20px''><b>6. Energy use, CWR use, and survivorship results for Snake River Fall Chinook Salmon under long-term average temperatures for the Columbia River </b></style>'
author: " "
date: " "
...
```{r plot energy hist together, fig.cap="Fig. 6.1 Histogram of percent energy lost for modeled Snake River Fall Chinook salmon migrating through different modeled thermalscapes."}
...
```{r energy lost boxplot, fig.cap="Fig. 6.2 Boxplot of percent energy lost for modeled Snake River Fall Chinook migrating through different modeled thermalscapes."}
...
kable(ED_used_table, col.names=c( "Scenario", "Minimum", "25% quantile","Median", "75% quantile", "Maximum"),row.names=FALSE, caption="Table 6.1 Percent energy used across different HexSim thermalscapes summarized for Snake River Fall Chinook.", digits=1)
```
...
kable(refuge_use_all, digits=0, col.names=c("Scenario", "CWR Residence (h/individual)"), caption="Table 6.2 Model output for total hours residing in cold water refuges summarized for Snake River Fall Chinook.")
```
...
kable(acute_all,digits=2, col.names=c("Scenario", "Total mortality"), caption="Table 6.3 Model output for percent of individuals dying from acute temperature stress summarized for Snake River Fall Chinook.")
```
...
p + facet_wrap(~scenario, ncol=1) + labs(x="Arrival date at end of modeled reach", y="Percent", title="Snake River Fall Chinook Salmon") + theme_classic()
```
