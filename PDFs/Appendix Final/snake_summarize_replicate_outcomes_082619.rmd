...
kable(acute_all, col.names=c("Scenario", "Total mortality"), caption="Table 6.3 Model output for percent of individuals dying from acute temperature stress summarized for Snake River Fall Chinook.")
```
