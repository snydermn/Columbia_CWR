...
A13<-read.table("D:/Results_4Populations/gr_Columbia2017A/combined/E13.csv", header=TRUE, sep=",")
B13<-read.table("D:/Results_4Populations/gr_Columbia2017A_NoCWR/combined/F13.csv", header=TRUE, sep=",")
C13<-read.table("D:/Results_4Populations/gr_Columbia2017Aplus1/combined/G13.csv", header=TRUE, sep=",")
D13<-read.table("D:/Results_4Populations/gr_Columbia2017Aplus1_NoCWR/combined/H13.csv", header=TRUE, sep=",")
...
```{r plot DD hist together, eval=FALSE, fig.cap="Fig. 3. Histograms of modeled Grande Ronde River summer steelhead accumulated degrees day over 18°C from Bonneville to the Snake River confluence in the Columbia River."}
plot_grid(c2, a2, b2, d2, g2, e2, f2,
          labels = c("A", "B", "C", "D", "E", "F", "G"),
          ncol = 3, nrow = 3)
```

```{r cum DD boxplot, eval=FALSE, fig.cap="Fig. 4. Boxplots of modeled Grande Ronde River summer steelhead accumulated degrees day over 18°C from Bonneville to the Snake River confluence in the Columbia River."}
...
# import in combined replicate DFs
A9<-read.table("D:/Results_4Populations/gr_Columbia2017A/combined/E9.csv", header=TRUE, sep=",")
B9<-read.table("D:/Results_4Populations/gr_Columbia2017A_NoCWR/combined/F9.csv", header=TRUE, sep=",")
C9<-read.table("D:/Results_4Populations/gr_Columbia2017Aplus1/combined/G9.csv", header=TRUE, sep=",")
D9<-read.table("D:/Results_4Populations/gr_Columbia2017Aplus1_NoCWR/combined/H9.csv", header=TRUE, sep=",")
...
# import in combined replicate DFs
A12<-read.table("D:/Results_4Populations/gr_Columbia2017A/combined/E12.csv", header=TRUE, sep=",")
B12<-read.table("D:/Results_4Populations/gr_Columbia2017A_NoCWR/combined/F12.csv", header=TRUE, sep=",")
C12<-read.table("D:/Results_4Populations/gr_Columbia2017Aplus1/combined/G12.csv", header=TRUE, sep=",")
D12<-read.table("D:/Results_4Populations/gr_Columbia2017Aplus1_NoCWR/combined/H12.csv", header=TRUE, sep=",")
