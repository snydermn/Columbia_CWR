...
hdr.boxplot.2d(prob = c(50, 90, 100), x=a_win_sthd$EntryTiming, y=a_win_sthd$ReservoirH, ylab="Migration Time outside CWRs", ylim=c(200, 600))
hdr.boxplot.2d(prob = c(50, 90, 100), x=b_win_sthd$EntryTiming, y=b_win_sthd$ReservoirH, ylim=c(200, 600))
hdr.boxplot.2d(prob = c(50, 90, 100), x=c_win_sthd$EntryTiming, y=c_win_sthd$ReservoirH, xlab="Entry Time (in relation to maximum temperature)", ylab="Migration Time outside CWRs", ylim=c(200, 600))
hdr.boxplot.2d(prob = c(50, 90, 100), x=d_win_sthd$EntryTiming, y=d_win_sthd$ReservoirH, xlab="Entry Time (in relation to maximum temperature)", ylim=c(200, 600))
dev.off()
