---
title: "Snake River Fall Chinook salmon summarized fitness outcomes"
author: "MNSnyder"
date: "9/10/2019"
...
Snake River Fall Chinook salmon Columbia River temperature time series from 2017. 
...
B13<-read.table("D:/Results_4Populations/snake_Columbia2017B_plus10/combined/E4.csv", header=TRUE, sep=",")
C13<-read.table("D:/Results_4Populations/snake_Columbia2017B_plus30/combined/F4.csv", header=TRUE, sep=",")
D13<-read.table("D:/Results_4Populations/snake_Columbia2017B_plus50/combined/G4.csv", header=TRUE, sep=",")
...
B9<-read.table("D:/Results_4Populations/snake_Columbia2017B_plus10/combined/E9.csv", header=TRUE, sep=",")
C9<-read.table("D:/Results_4Populations/snake_Columbia2017B_plus30/combined/F9.csv", header=TRUE, sep=",")
D9<-read.table("D:/Results_4Populations/snake_Columbia2017B_plus50/combined/G9.csv", header=TRUE, sep=",")
...
kable(refuge_use_all, col.names=c("Scenario", "Total CWR Residence (h)"), caption="Table 3. Model output for total hours residing n cold water refuges summarized for Snake River Fall Chinook salmon.")
```

```{r summarize dying fish}
# import in combined replicate DFs
A12<-read.table("D:/Results_4Populations/snake_Columbia2017B/combined/E3.csv", header=TRUE, sep=",")
B12<-read.table("D:/Results_4Populations/snake_Columbia2017B_plus10/combined/E3.csv", header=TRUE, sep=",")
C12<-read.table("D:/Results_4Populations/snake_Columbia2017B_plus30/combined/F3.csv", header=TRUE, sep=",")
D12<-read.table("D:/Results_4Populations/snake_Columbia2017B_plus50/combined/G3.csv", header=TRUE, sep=",")
...
kable(acute_all, col.names=c("Scenario", "Total mortality"), caption="Table 4. Model output for percent of individuals dying from acute temperature stress summarized for Snake River Fall Chinook salmon.")
